        ...
        function createStationCard(station) {
            ...
            card.innerHTML = `
                <div class="radio-image">
                    ${station.favicon ? `<img src="${station.favicon}" alt="Logo da ${station.name}" loading="lazy" onerror="this.onerror=null; this.src='https://via.placeholder.com/180x180/0f172a/e2e8f0?text=Rádio';">` : `<img src="https://via.placeholder.com/180x180/0f172a/e2e8f0?text=Rádio" alt="Logo padrão de rádio">`}
                </div>
